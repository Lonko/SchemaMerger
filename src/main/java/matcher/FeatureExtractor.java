...
//		String a1 = "a1";
//		String a2 = "a2";
//		Document d1 = new Document("spec", new Document("a1", "ATA 100###ATA 133"));
//		Document d2 = new Document("spec", new Document("a1", "IDE 133"));
//		Document d3 = new Document("spec", new Document("a1", "IDE 133"));
//		Document d4 = new Document("spec", new Document("a1", "ATA 133"));
//		Document d5 = new Document("spec", new Document("a2", "ATA 100 mb/s"));
//		Document d6 = new Document("spec", new Document("a2", "IDE 133 mb/s"));
//		Document d7 = new Document("spec", new Document("a2", "IDE 133 mb/s"));
//		Document d8 = new Document("spec", new Document("a2", "ATA 133 mb/s"));
//		docs.add(new Document[]{d1, d5});
//		docs.add(new Document[]{d2, d6});
//		docs.add(new Document[]{d3, d7});
//		docs.add(new Document[]{d4, d8});
//		System.out.println(fe.getMI(docs,a1,a2));
	}
}
