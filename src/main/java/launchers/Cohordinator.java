...
public class Cohordinator {
	...
	public static void main(String[] args){
		...
		if(alreadyTrained){
			...
			Map<String, List<String>> tSet = 
					c.generateTrainingSets(mdbc, config.getCategories(), new HashMap<String, List<String>>());
...
//							"modelClassifier.rda";
//		String tsPath = "/home/marco/workspace/SchemaMerger/src/main/resources/classification/"+
//							"1all_ts.csv";
//		RConnector r = new RConnector();
//		r.start();
...
////			fdc.printMatchSchema("schema_noMI_"+category, c.matchAllSourcesInCategory(websites, category, cm, 0, useFeature));
