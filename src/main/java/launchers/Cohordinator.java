...
public class Cohordinator {
	...
	/**
	 * Returns the DAO for algorithm TODO use proper dependency injection
	 * 
	 * @param config
	 * @return
	 */
	private static AlignmentDao getDao(Configurations config) {
		MongoDbConnectionFactory factory = MongoDbConnectionFactory.getMongoInstance(config.getMongoURI(),
