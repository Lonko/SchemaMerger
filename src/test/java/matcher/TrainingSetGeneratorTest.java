...
public class TrainingSetGeneratorTest {
	...
	public void setUp() throws Exception {
		...
		this.pExamples = Arrays.asList(
				new Tuple(A1, A1, WEBSITE_TEST_1, WEBSITE_TEST_2, CATEGORY), 
				...
				new Tuple(A1_2, A2_2, AlignmentDaoMock.MOCKED_WEBSITES.get(1),  AlignmentDaoMock.MOCKED_WEBSITE1, CATEGORY)
				
				
				);
		this.nExamples = Arrays.asList(new Tuple(A1, A2, WEBSITE_TEST_1, WEBSITE_TEST_2, CATEGORY), new Tuple(A1_2, A2_2, WEBSITE_TEST_1, WEBSITE_TEST_2, CATEGORY));
	}
